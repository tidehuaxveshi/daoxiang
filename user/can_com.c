...
void can_init(void)
{
	...
	can_rx_mask_update(&rxcan_1, 0x200, 0x7F0, FDCAN_FILTER_TO_RXFIFO0, 0, FDCAN_STANDARD_ID, FDCAN_DATA_FRAME);



	// can_tx_update(&txcan_test, MOTOR_ID, DATA_SIZE_TRANSMIT, FDCAN_EXTENDED_ID, FDCAN_DATA_FRAME);
